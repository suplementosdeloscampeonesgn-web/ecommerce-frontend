  ...
  return (
    ...
    >
      <div className="container d-flex flex-column flex-md-row align-items-center justify-content-between gap-3 px-3">
        ...
        {/* Links navegación interna */}
        <ul className="d-flex gap-4 fw-semibold fs-5 list-unstyled mb-0">
          <li>
            <Link to="/aviso" className="link-light text-decoration-none" style={{ transition: "color 0.2s" }}>
              Aviso de privacidad
            </Link>
          </li>
          <li>
            <Link to="/contacto" className="link-light text-decoration-none" style={{ transition: "color 0.2s" }}>
              Contacto
            </Link>
          </li>
        </ul>
        ...
        <div className="d-flex gap-3">
          <a href="https://facebook.com/SuplementosdeLosCampeonesGN" target="_blank" rel="noopener noreferrer" className="text-light transition">
          ...
          <a href="https://instagram.com/SuplementosdeLosCampeonesGN" target="_blank" rel="noopener noreferrer" className="text-light transition">
            <svg style={{ width: "28px", height: "28px" }} fill="currentColor" viewBox="0 0 24 24">
