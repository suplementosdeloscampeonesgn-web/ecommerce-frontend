...
    icon: <FaDumbbell style={{ fontSize: 54, color: "#01a2f5" }} />, // Icono ahora azul
    accent: "#01a2f5", // Color de acento azul
...
    icon: <FaFlask style={{ fontSize: 54, color: "#01a2f5" }} />, // Icono ahora azul
    accent: "#01a2f5", // Color de acento azul
...
    icon: <FaBolt style={{ fontSize: 54, color: "#01a2f5" }} />, // Icono ahora azul
    accent: "#01a2f5", // Color de acento azul
...
  return (
    <div className="container p-0" style={{ maxWidth: "1100px", marginTop: "40px" }}> {/* Eliminado 'my-5', añadido 'marginTop' */}
      <div
...
                  <a
                    href="/shop"
                    className="btn px-5 py-2 fw-bold bg-info text-white" // Botón ahora azul
                    style={{
                      borderRadius: 25,
                      fontSize: "1.12rem",
